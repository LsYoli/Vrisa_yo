          ...
          <tbody>
            {sortedVariables.map((variable) => (
              <tr key={variable.id}>
                ...
                <td>
                  <span className={`${styles.tag} ${variable.activo ? styles.statusApproved : styles.statusPending}`}>
                ...
                <td className={styles.actions}>
                  ...
                  <button className={styles.buttonDanger + ' ' + styles.button} onClick={() => deleteVariable(variable.id)}>
                    Eliminar
                  </button>
                </td>
              </tr>
